...
from model.tbftMLs import TBFTModel
tbftmodel_api = Blueprint('tbftmodel_api', __name__,
                   url_prefix='/api/tbftML')
api = Api(tbftmodel_api)
class TBFTModelAPI:
    class _Predict(Resource):
        def post(self):
            ...
            response = tbftModel.predict(passenger)
